...
@Component({
  selector: 'app-traininguserprofile',
  templateUrl: './traininguserprofile.component.html',
  styleUrls: ['./traininguserprofile.component.css']
})
export class TraininguserprofileComponent implements OnInit {
